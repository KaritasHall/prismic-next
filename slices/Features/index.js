      ...
      {prismicH.isFilled.link(item.buttonLink) && (
        <div>
          <PrismicLink
            ...
            className="group font-semibold text-black transition hover:text-indigo-800"
          >
...
const Features = ({ slice }) => {
  return (
    <Bounded as="section" className="bg-indigo-400 text-black">
      <div className="grid justify-items-center gap-6">
        {prismicH.isFilled.richText(slice.primary.tagline) && (
          <p className="max-w-lg text-center text-lg font-semibold uppercase tracking-widest text-black">
        ...
        <div className="grid max-w-prose justify-center gap-6 text-center">
          <PrismicRichText
            ...
            components={{
              heading1: ({ children }) => (
                <h2 className="s text-center text-4xl font-semibold text-black">
                  {children}
                </h2>
              ),
            }}
